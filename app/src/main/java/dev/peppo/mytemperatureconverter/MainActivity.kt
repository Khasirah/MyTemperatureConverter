package dev.peppo.mytemperatureconverter
...
import dev.peppo.mytemperatureconverter.ui.theme.MyTemperatureConverterTheme
...
fun GeneralTemperatureInput(
    ...
    Column(modifier) {
        OutlinedTextField(
            value = input,
            onValueChange = onValueChange,
            label = { stringResource(id = R.string.enter_temperature, scale.scaleName) },
            keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number),
        )
    }
}
